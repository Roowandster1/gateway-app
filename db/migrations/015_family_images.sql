...
--
-- 13 images covering 182 recipes by shape. A family image is a
...
UPDATE recipe SET image_url = '/recipes/family-beans-toast.webp',
  ...
  WHERE image_url IS NULL AND slug IN ('g-beans-bread', 'g-beans-bread-frozveg', 'g-beans-bread-toms', 'g-bread-carrot-cheese', 'g-bread-carrot-chicken', 'g-bread-carrot-chickpeas', 'g-bread-carrot-kidney', 'g-bread-carrot-lentils', 'g-bread-carrot-mince', 'g-bread-carrot-tuna', 'g-bread-cheese-toms', 'g-bread-chicken', 'g-bread-chicken-oil-peas-big', 'g-bread-chickpeas', 'g-bread-frozveg-lentils-oil-big', 'g-bread-frozveg-mince-big', 'g-bread-kidney', 'g-bread-lentils', 'g-bread-lentils-oil-peas-big', 'g-bread-mince', 'g-bread-mince-oil-big', 'g-bread-pb', 'g-bread-tuna');
UPDATE recipe SET image_url = '/recipes/family-bowl.webp',
                  image_is_family = true
  WHERE image_url IS NULL AND slug IN ('g-carrot-chicken', 'g-carrot-lentils', 'g-carrot-mince', 'g-cheese-frozveg', 'g-cheese-peas', 'g-chickpeas-oil', 'g-frozveg-kidney-oil', 'g-kidney-oil-peas');
...
UPDATE recipe SET image_url = '/recipes/family-eggs.webp',
                  image_is_family = true
  WHERE image_url IS NULL AND slug IN ('g-bread-carrot-eggs', 'g-eggs-toms');
UPDATE recipe SET image_url = '/recipes/family-jacket.webp',
                  image_is_family = true
  WHERE image_url IS NULL AND slug IN ('g-carrot-chicken-potato', 'g-carrot-lentils-potato', 'g-carrot-mince-potato', 'g-carrot-mince-potato-big', 'g-carrot-potato-tuna', 'g-cheese-oil-peas-potato-big', 'g-cheese-peas-potato-stock', 'g-chicken-oil-potato-big', 'g-chicken-peas-potato-big', 'g-chicken-potato', 'g-chickpeas-curry-peas-potato', 'g-chickpeas-peas-potato-stock', 'g-eggs-frozveg-potato', 'g-eggs-peas-potato', 'g-eggs-potato', 'g-frozveg-lentils-potato-big', 'g-kidney-peas-potato', 'g-lentils-oil-potato-big', 'g-lentils-potato', 'g-mince-potato', 'g-mince-potato-big', 'g-potato-tuna');
...
UPDATE recipe SET image_url = '/recipes/family-rice-pulse.webp',
                  image_is_family = true
  WHERE image_url IS NULL AND slug IN ('g-carrot-cheese-oil-rice-big', 'g-carrot-lentils-rice', 'g-carrot-lentils-rice-big', 'g-cheese-frozveg-oil-rice-big', 'g-eggs-peas-rice', 'g-frozveg-lentils-rice');
UPDATE recipe SET image_url = '/recipes/family-wrap.webp',
                  image_is_family = true
  WHERE image_url IS NULL AND slug IN ('g-banana-pb-tortilla', 'g-beans-carrot-tortilla-big', 'g-beans-frozveg-tortilla', 'g-beans-peas-tortilla', 'g-beans-tortilla', 'g-beans-tortilla-big', 'g-carrot-cheese-tortilla-big', 'g-carrot-chicken-tortilla', 'g-carrot-chicken-tortilla-big', 'g-carrot-chickpeas-tortilla-big', 'g-carrot-eggs-tortilla', 'g-carrot-kidney-tortilla-big', 'g-carrot-lentils-tortilla', 'g-carrot-lentils-tortilla-big', 'g-carrot-mince-tortilla', 'g-carrot-mince-tortilla-big', 'g-carrot-tortilla-tuna', 'g-cheese-frozveg-tortilla', 'g-cheese-peas-tortilla', 'g-cheese-tortilla', 'g-cheese-tortilla-big', 'g-chicken-tortilla', 'g-chicken-tortilla-big', 'g-chickpeas-frozveg-tortilla', 'g-chickpeas-peas-tortilla', 'g-chickpeas-tortilla-big', 'g-curry-eggs-tortilla', 'g-eggs-oil-peas-tortilla-big', 'g-eggs-tortilla', 'g-frozveg-kidney-tortilla', 'g-kidney-peas-tortilla', 'g-kidney-tortilla-big', 'g-lentils-tortilla', 'g-lentils-tortilla-big', 'g-mince-tortilla', 'g-mince-tortilla-big', 'g-pb-tortilla', 'g-tortilla-tuna');
UPDATE recipe SET image_url = '/recipes/family-yoghurt.webp',
                  image_is_family = true
  WHERE image_url IS NULL AND slug IN ('g-banana-pb-yoghurt', 'g-banana-yoghurt', 'g-oats-yoghurt', 'g-pb-yoghurt');
